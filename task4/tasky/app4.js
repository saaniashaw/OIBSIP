...
let registerNameE1 = document.getElementById("typeName");
...
let registerNameErrorMessageE1 = document.getElementById("typeNameErrorMessage");
...
function login() {
    ...
    loginregisterNameErrorMessageE1.textContent = '';
    ...
    if (localStorage.getItem(username) === password) {
        ...
        loginregisterNameErrorMessageE1.textContent = 'Please enter your name.';
    } else {
